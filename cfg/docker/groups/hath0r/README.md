# Hath0r Docker group (framework pointer)

> Issue: #48 · Canonical compose: control tower **HATH0R-CLI**  
...
| UXP | experience | profile `apps` when image present |

Patterned after **BAI / Hath0r / 1-Nation** ATC-managed groups. This member repo does **not** vendor the full compose tree; operate from the control tower checkout.
...
- `cfg/docker/workflows/hath0r-framework-stack.json` — Hathor validate → Docker Factory execute
