...
**AC:** All CORE §16.5/§16.8 acceptance tests are executable against this surface; no ordinary bot/capability-dispatch trace contains a Tower call, while explicit `hath0r tower …` traces do.
