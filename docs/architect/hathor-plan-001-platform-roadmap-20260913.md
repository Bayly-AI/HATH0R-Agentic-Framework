...
|---|---|---|---|
| **WS1 Chassis & CLI core** | `hath0r` binary, cobra tree (9 domains, ADR-003), exit/envelope contract, UPL tooling (`repo init|validate`), schema introspection | CORE §3/§4/§7, TS-001 §2–§3 | — |
...
| **M-F Containers & dogfood** | WS8 reference images + build gate; HATHOR self-hosted in strict mode | §16.10, §16.11 |
...
4. Dogfood order: HATHOR repo → InfraAPI wrap (PLAN-002 X2-S3) → one Communications workflow under a conducted run.
